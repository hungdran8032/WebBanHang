...
import com.ecommerce.WebEcommerce.repository.PaymentOrderRepository;
import com.ecommerce.WebEcommerce.service.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentOrder getPaymentOrderById(Long orderId) throws Exception {
        return paymentOrderRepository.findById(orderId).orElseThrow(()-> new Exception("Khong tim thay"));
    }
